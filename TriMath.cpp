...
* Return          £ºThe absolute value of the input number.
**********************************************************/         
...
* Description        : Calculate the square root of an input number, with a precision to limit the deviation.
						Using Newton iteration to work out, namely, x_k+1 = 0.5 * (x_k + (a ¡Âx_k)), where <a> is the input number which
...
* Return          £ºThe square root of the input number.
**********************************************************/    
...
* Return          £ºThe double factorial of the input number.
**********************************************************/    
...
* Return          £ºThe factorial of the input number.
**********************************************************/  
...
* Return          £ºThe exponent value, namely, it will return <num> ^ <index>.
**********************************************************/  
...
* Return          £ºThe radian value. Namely, <rad> = <pi> * <angle> / 180.
**********************************************************/  
...
* @pi            : Pi given in the programme. 
* Return          £ºThe angle value. Namely, <angle> = 180 * <radian> / <pi>.
**********************************************************/ 
...
* @pi            : Pi given in the programme. 
* Return          £ºThe approximated sin value, namely, sin(x) ¡Öx - x^3 / 3! + x ^ 5 / 5! - ... 
**********************************************************/ 
...
* @n            : The numebr of items of taylor formula, the larger, the more precise.
* @pi            : Pi given in the programme. 
* Return          £ºThe approximated cosine value, namely, cos(x) ¡Ö1 - x^2 / 2! + x^4 / 4! - ... 
**********************************************************/ 
...
* @n            : The numebr of items of taylor formula, the larger, the more precise.
* @pi            : Pi given in the programme. 
* Return          £ºThe approximated tangent value, namely, tan(x) ¡Ötaylor_sin(x) / taylor_cos(x).
...
* @x            : The input number to get the arcsin value of.
* @n            : The numebr of items of taylor formula, the larger, the more precise.
* Return          £ºThe approximated arcsin value, namely, arcsin(x) ¡Öx + 1!!/2!! * x^3/3 + 3!!/4!! * x^5/5 + ...
